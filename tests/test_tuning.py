...
(0)Result vw --oaa 4 --quiet -b 18... vw_average_loss=0.48000
Result vw --oaa 4 --quiet -b 20... vw_average_loss=0.50000
Best vw options = --oaa 4 --quiet -b 18
Best vw_average_loss = 0.48000

[tuning_acc_kfold10]
$ vwoptimize.py -d small_ag_news.csv --oaa 4 --metric acc -b 18/20? --kfold 10 --quiet
(0)Result vw --oaa 4 --quiet -b 18... acc=0.52000
Result vw --oaa 4 --quiet -b 20... acc=0.50000
Best vw options = --oaa 4 --quiet -b 18
Best acc = 0.52000
acc = 0.38
...
(0)Result vw --oaa 4 --quiet -b 18... vw_average_loss=0.62000
Result vw --oaa 4 --quiet -b 20... vw_average_loss=0.60000*
Best vw options = --oaa 4 --quiet -b 20
Best vw_average_loss = 0.60000

[tuning_acc]
$ vwoptimize.py -d small_ag_news.csv --oaa 4 --metric acc -b 18/20? --quiet   # same result, since acc = 1-vw_average_loss in this case
(0)Result vw --oaa 4 --quiet -b 18... acc=0.38000
Result vw --oaa 4 --quiet -b 20... acc=0.40000*
Best vw options = --oaa 4 --quiet -b 20
Best acc = 0.40000
acc = 0.4
...
(0)Result vw --oaa 4 --quiet -b 18... acc=0.38000   vw_average_loss=0.62000
Result vw --oaa 4 --quiet -b 20... acc=0.40000*  vw_average_loss=0.60000
Best vw options = --oaa 4 --quiet -b 20
Best acc = 0.40000
acc = 0.4
...
(0)Result vw --oaa 4 --quiet -b 18... vw_average_loss=0.48000   brier=ValueError auc=ValueError acc=0.52000 num_features=4103.2
Result vw --oaa 4 --quiet -b 20... vw_average_loss=0.50000   brier=ValueError auc=ValueError acc=0.50000 num_features=4138.8
Best vw options = --oaa 4 --quiet -b 18
Best vw_average_loss = 0.48000
...
(0)Result vw --quiet... vw_average_loss=2.39627
...
Best options with --max_words 2 = --quiet
Best vw_average_loss with '--max_words 2' = 2.80694
Result vw --quiet... vw_average_loss=3.16410
Best options with --max_words 5 = --quiet
Best vw_average_loss with '--max_words 5' = 3.16410
Result vw --quiet... vw_average_loss=2.40069
Best options with --strip_punct = --quiet
Best vw_average_loss with '--strip_punct' = 2.40069
Result vw --quiet... vw_average_loss=2.79783
Best options with --strip_punct --max_words 2 = --quiet
Best vw_average_loss with '--strip_punct --max_words 2' = 2.79783
Result vw --quiet... vw_average_loss=3.37548
Best options with --strip_punct --max_words 5 = --quiet
Best vw_average_loss with '--strip_punct --max_words 5' = 3.37548
Best preprocessor options = <none>
Best vw options = --quiet
Best vw_average_loss = 2.39627
