...
Result vw --oaa 4 --quiet -b 18... vw_average_loss=0.48000
...
Result vw --oaa 4 --quiet -b 18... acc=0.52000
...
Result vw --oaa 4 --quiet -b 18... vw_average_loss=0.62000
...
Result vw --oaa 4 --quiet -b 18... acc=0.38000
...
Result vw --oaa 4 --quiet -b 18... acc=0.38000   vw_average_loss=0.62000
...
Result vw --oaa 4 --quiet -b 18... vw_average_loss=0.48000   brier=ValueError auc=ValueError acc=0.52000 num_features=4103.2
