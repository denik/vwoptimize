...
'''.lstrip())
    ...
    def test_predictions(self):
        ...
        self.assert_command_output('head -n 10 iris.vw | PYTHON ../vwoptimize.py --cv --oaa 3 -p tmp/cv_predictions -r tmp/cv_raw_predictions -f tmp/model.vwoptimize --quiet --lesslogs', '')
